...
INSERT INTO `aulas` VALUES ('Banco de dados','13hs','fazer um banco de dados MYSQL','I,II'),('Criptografia','10hs','resolver exercicios do site criptopals','I'),('Engenharia reversa','08hs','fazer engenharia reversa em um arquivo binario','I,II'),('Etica','15hs','elaborar uma redacao sobre hactivism e etical hacking','I'),('Rede','15hs','calcular qual mascara de rede deve ser usada em um exemplo de sistema','I,II,III,IV'),('Seguranca ofensiva','08hs','realizar um ataque em rede ou criar um malware','I,II,III,IV'),('Web','13hs','fazer um desafio do CTF','I,II');
...
-- Dump completed on 2020-02-28 22:59:59
